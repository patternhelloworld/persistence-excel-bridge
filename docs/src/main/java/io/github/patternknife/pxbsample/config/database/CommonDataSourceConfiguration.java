...
@EnableJpaRepositories(
        basePackages = {"io.github.patternknife.pxbsample.domain", "io.github.patternknife.pxbsample.config.security", "io.github.patternknife.pxb.domain"},
...
public class CommonDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean commonEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("io.github.patternknife.pxbsample.domain", "io.github.patternknife.pxbsample.config.security", "io.github.patternknife.pxb.domain")
