...
import io.github.patternknife.pxbsample.config.response.error.exception.auth.*;
import io.github.patternknife.pxbsample.config.response.error.exception.data.*;
import io.github.patternknife.pxbsample.config.response.error.exception.auth.*;
import io.github.patternknife.pxbsample.config.response.error.exception.data.*;
import io.github.patternknife.pxbsample.config.response.error.exception.file.FileNotFoundException;
import io.github.patternknife.pxbsample.config.response.error.exception.payload.SearchFilterException;
