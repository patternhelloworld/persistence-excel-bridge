package io.github.patternknife.pxbsample.domain.admin.service;


import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import io.github.patternknife.pxbsample.config.database.CommonQuerydslRepositorySupport;
import io.github.patternknife.pxbsample.config.database.SelectablePersistenceConst;
import io.github.patternknife.pxbsample.config.response.error.exception.data.ResourceNotFoundException;
import io.github.patternknife.pxbsample.config.security.principal.AccessTokenUserInfo;
import io.github.patternknife.pxbsample.domain.admin.dao.AdminRepository;
import io.github.patternknife.pxbsample.domain.admin.dao.AdminRoleRepository;
import io.github.patternknife.pxbsample.domain.admin.dto.AdminDTO;
import io.github.patternknife.pxbsample.domain.admin.dto.AdminSearchFilter;
import io.github.patternknife.pxbsample.domain.admin.dto.QAdminDTO_OneWithRoleIdsRes;
import io.github.patternknife.pxbsample.domain.admin.entity.*;
import io.github.patternknife.pxbsample.domain.admin.entity.*;
import io.github.patternknife.pxbsample.domain.common.dto.DateRangeFilter;
import io.github.patternknife.pxbsample.domain.common.dto.SorterValueFilter;
import io.github.patternknife.pxbsample.domain.role.dao.RoleRepository;
import io.github.patternknife.pxbsample.domain.role.entity.QRole;
import io.github.patternknife.pxbsample.domain.role.entity.Role;
import io.github.patternknife.pxbsample.util.CommonConstant;
import io.github.patternknife.pxbsample.util.CustomUtils;
import io.github.patternknife.pxbsample.util.PaginationUtil;
