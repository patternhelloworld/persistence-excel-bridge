package io.github.patternknife.pxbsample.config.security.principal;
...
/*
* 	If there are other modules, this class must also be located in io.github.patternknife.pxbsample.interestedtreatmentpart.dto.security.
* */
