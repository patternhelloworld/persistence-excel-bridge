package io.github.patternknife.pxbsample.config.queue.initializer;


import io.github.patternknife.pxb.domain.exceldbreadtask.queue.ExcelDBReadTaskEventQueue;
import io.github.patternknife.pxb.domain.exceldbwritetask.queue.ExcelDBWriteTaskEventQueue;
