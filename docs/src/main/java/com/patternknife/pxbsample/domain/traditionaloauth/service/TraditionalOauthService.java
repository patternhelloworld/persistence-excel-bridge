package com.patternknife.pxbsample.domain.traditionaloauth.service;

import com.patternknife.pxbsample.domain.traditionaloauth.bo.BasicTokenResolver;
import com.patternknife.pxbsample.domain.traditionaloauth.dto.SpringSecurityTraditionalOauthDTO;
import com.patternknife.pxbsample.config.logger.module.NonStopErrorLogConfig;
import com.patternknife.pxbsample.config.response.error.exception.auth.UnauthenticatedException;
import com.patternknife.pxbsample.config.response.error.exception.auth.UnauthorizedException;
import com.patternknife.pxbsample.config.response.error.message.SecurityExceptionMessage;
import com.patternknife.pxbsample.config.security.OAuth2ClientCachedInfo;
