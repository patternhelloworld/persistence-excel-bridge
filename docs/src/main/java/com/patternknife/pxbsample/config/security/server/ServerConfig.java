package com.patternknife.pxbsample.config.security.server;


import com.patternknife.pxbsample.config.security.token.TokenResponseSuccessHandler;
import com.patternknife.pxbsample.config.security.token.generator.CustomDelegatingOAuth2TokenGenerator;
import com.patternknife.pxbsample.config.security.converter.auth.endpoint.CustomGrantAuthenticationConverter;
import com.patternknife.pxbsample.config.security.errorhandler.auth.authentication.AuthenticationFailureHandlerImpl;
import com.patternknife.pxbsample.config.security.errorhandler.resource.authentication.AuthenticationEntryPointToGlobalExceptionHandler;
import com.patternknife.pxbsample.config.security.errorhandler.resource.authorization.CustomAccessDeniedHandler;
import com.patternknife.pxbsample.config.security.provider.auth.endpoint.CustomAuthenticationProvider;
import com.patternknife.pxbsample.config.security.provider.auth.introspectionendpoint.Oauth2OpaqueTokenAuthenticationProvider;
import com.patternknife.pxbsample.config.security.provider.resource.introspector.JpaTokenStoringOauth2TokenIntrospector;
import com.patternknife.pxbsample.config.security.serivce.CommonOAuth2AuthorizationCycle;
import com.patternknife.pxbsample.config.security.serivce.Oauth2AuthenticationHashCheckService;
import com.patternknife.pxbsample.config.security.serivce.persistence.authorization.OAuth2AuthorizationServiceImpl;
import com.patternknife.pxbsample.config.security.serivce.persistence.client.RegisteredClientRepositoryImpl;
import com.patternknife.pxbsample.config.security.serivce.userdetail.ConditionalDetailsService;
