package com.patternknife.pxbsample.config.logger.module;

import com.patternknife.pxbsample.config.logger.common.CommonLoggingRequest;
...
public class ResponseErrorLogConfig {
    ...
    @AfterReturning(pointcut = ("within(com.patternknife.pxbsample.config.response.error..*)"),
