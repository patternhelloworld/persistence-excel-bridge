package com.patternknife.pxbsample.config.security.principal;
...
/*
* 	If there are other modules, this class must also be located in com.patternknife.pxbsample.interestedtreatmentpart.dto.security.
* */
