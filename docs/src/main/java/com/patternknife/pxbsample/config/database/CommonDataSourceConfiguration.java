...
@EnableJpaRepositories(
        basePackages = {"com.patternknife.pxbsample.domain", "com.patternknife.pxbsample.config.security", "com.patternknife.pxb.domain"},
...
public class CommonDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean commonEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.patternknife.pxbsample.domain", "com.patternknife.pxbsample.config.security", "com.patternknife.pxb.domain")
