...
-- 테이블 데이터 sc_oauth2_pji.admin:~1 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `clinic` (
                                        ...
                                        `full_address` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                        `phone_number` varchar(171) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- 테이블 sc_oauth2_pji.excel_db_read_task 구조 내보내기
CREATE TABLE IF NOT EXISTS `excel_db_read_task` (
                                                    `id` bigint NOT NULL AUTO_INCREMENT,
...
-- 테이블 데이터 sc_oauth2_pji.excel_db_read_task:~0 rows (대략적) 내보내기

-- 테이블 sc_oauth2_pji.excel_db_write_task 구조 내보내기
CREATE TABLE IF NOT EXISTS `excel_db_write_task` (
                                                     `id` bigint NOT NULL AUTO_INCREMENT,
                                                     `group_id` bigint DEFAULT NULL,
                                                     `startRow` int DEFAULT NULL,
                                                     `endRow` int DEFAULT NULL,
...
-- 테이블 데이터 sc_oauth2_pji.excel_db_write_task:~0 rows (대략적) 내보내기

-- 테이블 sc_oauth2_pji.excel_group_task 구조 내보내기
CREATE TABLE IF NOT EXISTS `excel_group_task` (
                                                  `id` bigint NOT NULL AUTO_INCREMENT,
                                                  `status` tinyint NOT NULL DEFAULT '0',
                                                  `row_count_per_task` int NOT NULL DEFAULT '0',
                                                  `total_row` bigint DEFAULT NULL,
                                                  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                                  `relative_file_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                                  `saved_file_ext` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- 테이블 데이터 sc_oauth2_pji.excel_group_task:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 sc_oauth2_pji.oauth_refresh_token:~21 rows (대략적) 내보내기
